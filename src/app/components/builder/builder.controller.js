...
export FbFormObjectEditableController = function($scope, $injector) {
    var $builder;
...
export FbComponentsController = function($scope, $injector) {
    var $builder;
    $builder = $injector.get('$builder');
...
export FbFormObjectController = function($scope, $injector) {
    var $builder;
    $builder = $injector.get('$builder');
